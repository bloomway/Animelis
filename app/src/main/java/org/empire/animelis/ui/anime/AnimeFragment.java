 ...
 * {@link AnimeFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link AnimeFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class AnimeFragment extends AbstractFragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AddAnimeDialogFragment dialog = (AddAnimeDialogFragment) DialogFragmentFactory.getDialogFragment("Anime");
