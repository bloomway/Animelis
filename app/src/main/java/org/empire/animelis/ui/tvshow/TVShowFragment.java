...
import org.empire.animelis.ui.AbstractFragment;
import org.empire.animelis.ui.DialogFragmentFactory;
...
public class TVShowFragment extends AbstractFragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        // Inflate the layout for this fragment
        FloatingActionButton fab = (FloatingActionButton) getActivity().findViewById(R.id.fab_tvshow);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                /*Snackbar.make(view, "Replace with your own action", Snackbar.LENGTH_LONG)
                        .setAction("Action", null).show();*/
                AddTVShowDialogFragment dialog = (AddTVShowDialogFragment) DialogFragmentFactory.getDialogFragment("TVShow");
